...
import { cancelTransportObligation } from "../aggregate/TransportObligation.js";

/**
 * Cancela una obligación no terminal.
 */
export class CancelarTransportObligationCommand {
  /**
  ...
  async execute(transportObligationId) {
    ...
    try {
      const { obligation, events } = cancelTransportObligation(current);
