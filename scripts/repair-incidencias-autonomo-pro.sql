-- Incidencias — Autónomo PRO (empresa_id null en servicio e incidencia)
-- Ejecutar en Supabase SQL Editor si aparece: incidencias: servicio sin empresa_id

-- Contenido idéntico a supabase/migrations/20260530150000_incidencias_autonomo_pro.sql
